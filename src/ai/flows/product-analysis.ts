...
const productAnalysisPrompt = ai.definePrompt({
  ...
  7.  **Alternative:** If there is a clearly better alternative (e.g., more sustainable, healthier), suggest one. If not, state that no better alternative is available.
